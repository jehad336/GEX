  ...
  return (
    <div className="min-h-screen">
      ...
      />
        ...
        <section className="premium-hero flex flex-col gap-3 px-1 py-2 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <div className="luxury-kicker mb-1.5 flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.16em]">
              <span aria-hidden="true">✦</span> GEX workspace
            </div>
            <h1 className="text-xl font-bold tracking-tight sm:text-2xl">GEX Market Intelligence</h1>
            <p className="mt-1 max-w-2xl text-xs leading-relaxed text-muted sm:text-sm">Gamma exposure, dealer positioning and options context in one place.</p>
          </div>
