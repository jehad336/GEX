...
export function SidebarNav({ symbol }: { symbol: string }) {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-50 hidden w-60 flex-col border-r border-line/70 bg-bg xl:flex">
      <div className="flex h-[68px] items-center gap-3 border-b border-line/80 px-5">
        <div className="grid h-9 w-9 place-items-center rounded-xl border border-accent/25 bg-accent/10 text-base font-black text-accent">
          Γ
        </div>
      ...
      <div className="border-b border-line/70 p-3">
        <div className="rounded-xl border border-line/75 bg-surface p-3">
